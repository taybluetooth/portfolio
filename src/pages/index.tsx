...
const SocialsContainer = styled.div`orientation: left; bottom: 0; position: fixed; width: 40px;`
...
const EmailContainer = styled.div`
  ...
  bottom: 0;
  right: 0;
  orientation: right; position: fixed; width: 40px;
  @media only screen and (max-width: 1024px) {
    display: none;
  }
`;
  ...
  return (
    <Layout>
      ...
      <SocialsContainer><SocialsList>
        ...
        </SocialsList></SocialsContainer>
        <EmailContainer>
          <Email href="mailto:callumtaylorbusiness@gmail.com?subject=Business Enquiry from Portfolio.">callumtaylorbusiness@gmail.com</Email>
        </EmailContainer>
    </Layout>
  );
};
